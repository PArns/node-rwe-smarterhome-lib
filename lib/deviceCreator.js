...
MotionDetectionSensor = function(parseData, API) {
    MotionDetectionSensor.super_.call(this, parseData, API);
};

util.inherits(MotionDetectionSensor, PhysicalSensor);

LuminanceSensor = function(parseData, API) {
    LuminanceSensor.super_.call(this, parseData, API);
};

util.inherits(LuminanceSensor, PhysicalSensor);
