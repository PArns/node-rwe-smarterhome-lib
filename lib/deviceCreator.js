...
var stateClass = require("./stateCreator").createState;
...
BaseDevice = function (parseData, API) {
    ...
    this._updateState = function (settings) {
        that.State = stateClass(settings);
    ...
    this.setState = function (state, callback) {
        var c = that.State ? that.State : stateClass(that);
...
WindowDoorSensor = function (parseData, API) {
    ...
    this.Installation = parseData.Installation;
    this.EventFilterTime = parseData.EventFilterTime;
    this.WOpFunc = parseData.WOpFunc;
};
